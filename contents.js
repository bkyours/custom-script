...
var questionAnswerForSeller = [
    ...
    },
    {
        ...
        "ans": "The timing of when you get paid varies depending on whether the transaction is paid for via Stripe or PayPal.  With Stripe, once a buyer has marked their transaction with you as complete, it can take around 7 days for Stripe to deposit money into your bank account.  Rest assured that you will get your money.  Prior to purchasing your item, a buyer must enter credit card details and the money is held in escrow with Stripe.  In the case that the buyer does not mark the transaction as complete, BarkYours automatically marks all transactions as complete in 30 days, at which point Stripe will initiate your payment to your bank account.  With PayPal, the money moves to your account automatically when you accept the transaction.  There is no holding period."
    },
    {
        "qns": "I have accepted the buyer’s payment but it’s not in my bank account. What’s going on?",
        "ans": "If you use Stripe, the buyer must mark the transaction as completed in their dashboard before funds are released to you.  You will be notified via your BarkYours inbox when they do this.  Usually they do this when they have received the item and are happy with it.  Once they have marked the transaction as completed it usually takes about 7 days for Stripe to pay the amount into your bank account.  If you know the buyer has marked the order as completed and you still haven’t received your payment and it has been longer than 7 days please contact us at info@barkyours.com and we will do what we can to help.  If the buyer does not mark the transaction as complete, Stripe will automatically send you your money after 30 days."
    },
    {

...
$(document).ready(function () {
    ...
    function displayLandingPage() {
        ...
        $(".home-fluid-thumbnail-grid").append('<div class="col-12 full-width text-center" style="margin-top: 20px; height: 45px;"> <a class="view-all-listing-link-btn" href="https://www.barkyours.com/?view=grid"> VIEW ALL LISTINGS</a></div>');
